...
<body style="margin: 0 auto;">
	...
	<div class="row" style="margin: auto;">
		...
		<form action="/semi/project/sreply/created_ok.do" method="post"
					name="myForm2">				
		<input type="hidden" name="qno" value="${dto.reviewNo }">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="user-comment">
                                       ...
                                       <input type="hidden" name="reviewNo" value="${dto.reviewNo }">
                                            <h4>작성자 : ${rdto.userId } <span class="comment-replay" onclick="location.href='/semi/sreply/updated.do?rno=${rdto.rno}'">수정</span></h4>
                                            <h4>내용 : ${rdto.content } <span class="comment-replay" onclick="replyDeleteBtn();">삭제</span></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
