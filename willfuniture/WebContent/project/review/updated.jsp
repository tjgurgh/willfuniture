...
<script type="text/javascript">
	function send() {
		...
		f.action = "/semi/sreview/updated_ok.do";
		f.submit();
	}
</script>
	...
	<div class="row" style="margin: auto;">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<div class="basic-login-inner">
				<h3>후기 게시판</h3>
				<p></p>
				<form action="/semi/sreview/updated_ok.do" method="post"
					name="myForm">
				...
				<input type="hidden" value="1" name="productNo">
				<input type="hidden" value="1" name="orderNo">
