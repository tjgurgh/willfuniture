	...
	<div class="product-status mg-b-15">
		<div class="container-fluid">
            ...
            <c:when test="${sessionScope.customInfo.userId!='admin'}">	
						...
						onclick="location.href='<%=cp%>/sqna/created.do'">문의 작성</button>
						<button class="btn btn-default"
						onclick="location.href='<%=cp%>/sqna/myList.do?userId=${sessionScope.customInfo.userId}'">문의 목록</button>
			</c:when>
			<c:otherwise>			
							...
							<table border="1">
								...
								<c:forEach var="dto" items="${lists }">
									<tr>
										...
										<a href="${articleUrl }&qno=${dto.qno }"><img src="/semi/project/qna/re.gif"/><font color="#ff0000">${dto.parentNo}번 [답변완료]</font>${dto.subject }</a>
										</c:if>
										</c:if>
						...
						<div class="custom-pagination" align="center">
							<form action="<%=cp%>/sqna/myList.do" name="myForm">
